...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:25%"><!-- wp:site-title {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"18px"}},"className":"wp2-site-title","fontFamily":"nunito-sans"} /-->
