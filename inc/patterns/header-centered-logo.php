 ...
 */
return array(
	'title'      => __( 'Header centered logo', 'wp2' ),
	'categories' => array( 'wp2-headers' ),
	...
	'content'    => '
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:80%"><!-- wp:site-title {"textAlign":"center","style":{"typography":{"textTransform":"uppercase","letterSpacing":"18px"}},"className":"wp2-site-title","fontFamily":"nunito-sans"} /-->
			...
			<!-- wp:navigation-link {"label":"Home","url":"wp2.deothemes.com","kind":"custom","isTopLevelLink":true} /-->
			...
			<!-- wp:navigation-link {"label":"About","type":"page","id":13,"url":"#","kind":"post-type","isTopLevelLink":true} /-->

			<!-- wp:navigation-link {"label":"Contact","type":"page","id":15,"url":"#","kind":"post-type","isTopLevelLink":true} /-->
			<!-- /wp:navigation --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns --></div>
			<!-- /wp:group -->',
